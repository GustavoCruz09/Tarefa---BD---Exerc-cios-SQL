...
SELECT e.nome, CAST(AVG(v.distanciaPercorrida) as decimal(10,2)) as mediaDist , SUM(v.distanciaPercorrida) as DistanciaPercorrida
FROM empresa e, viagem v, carro c 
WHERE c.idEmpresa = e.id and v.idCarro = c.id
GROUP BY e.nome
